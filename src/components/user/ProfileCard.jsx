...
import { MD5 } from "crypto-js";
 ...
 export default function ProfileCard({ fullName, userEmail, qrlink }) {
  ...
  return (
    ...
    <QRCode title="Passport QR" value={qrlink} size={50} level="L" className="object-cover w-full rounded-b-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-r-lg"/>
</div>
  );
}