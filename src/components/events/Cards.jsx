...
export default function Example({ key, title, imageUrl, description, tags, buttonLabel, linkTo }) {
  return (
    <Card className="w-full max-w-[26rem] shadow-lg grayscale duration-500 hover:grayscale-0">
